...
variable "oidc_bucket_name" {
  ...
  type        = string
  default     = "platform-stage-oidc-eun1-125788629837"
}
...
variable "enable_flow_logs" {
  description = "Enable VPC flow logs. Off in stage to avoid CloudWatch ingestion charges on a short-lived environment."
  type        = bool
  default     = false
}
